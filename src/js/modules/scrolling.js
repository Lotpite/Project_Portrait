const scrolling = (selectorUp) => {
    ...
    let links = document.querySelectorAll('[href^="#"]'), // Собираем все ссылки которые начинаются с #
        speed = 0.3;
        ...
        links.forEach(link => {
            link.addEventListener('click', function(event) {
                ...
                let widthTop = document.documentElement.scrollTop,
                    hash = this.hash,
                    toBlock = document.querySelector(hash).getBoundingClientRect().top, // получить верхние координаты
                    start = null;
